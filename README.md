...
This config file is a script that can provide defaults for scrolls by setting config.OPTION_NAME.  For example:
```
config.pg_username = 'root'
config.pg_password = ''
config.guard_notifications = false
```
